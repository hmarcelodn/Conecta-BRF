...
'use strict';
    ...
    function Dashboard($http, Database) {
        ...
        function synchronizeDating() { 
            return $http.get('http://ws.brf-horizonte.com/get/dashboard/dating/?token=560a100abad225d5afdf4fc6e5334917');
        }
        
        function synchronizeTargets(userId) {
            return $http.get('http://ws.brf-horizonte.com/get/user/target/?token=560a100abad225d5afdf4fc6e5334917&id_user=' + userId);
        }
